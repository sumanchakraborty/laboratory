...
-   [Set up the Ansible host](#set-up-the-ansible-host)
-   [Gather Facts module](#gather-facts-module)
    -   [Get list of volumes](#get-list-of-volumes)
    -   [Get list of arrays](#get-list-of-arrays)
    -   [Get list of storage group](#get-list-of-storage-group)
    -   [Get list of storage resource
        pool](#get-list-of-storage-resource-pool)
    -   [Get list of port groups](#get-list-of-port-groups)
    -   [Get list of hosts](#get-list-of-hosts)
    -   [Get list of host groups](#get-list-of-host-groups)
    -   [Get list of ports](#get-list-of-ports)
    -   [Get list of masking views](#get-list-of-masking-views)
    -   [Get list of RDF groups](#get-list-of-rdf-groups)
    -   [Get array health status](#get-array-health-status)
    -   [Get list of volumes and storage groups with
        filter](#get-list-of-volumes-and-storage-groups-with-filter)
    -   [Gather Facts module
        parameters](#gather-facts-module-parameters)
        -   [Table 2. Parameters ](#table-2.-parameters)
        -   [Table 2. Parameters
            (continued)](#table-2.-parameters-continued)
-   [Storage group module](#storage-group-module)
    -   [Get details of storage group including the
        volumes](#get-details-of-storage-group-including-the-volumes)
    -   [Create empty storage group](#create-empty-storage-group)
    -   [Delete empty storage group](#delete-empty-storage-group)
    -   [Add existing volumes to the existing storage
        group](#add-existing-volumes-to-the-existing-storage-group)
    -   [Add new volumes to SRDF protected storage
        group](#add-new-volumes-to-srdf-protected-storage-group)
    -   [Create new volumes for existing storage
        group](#create-new-volumes-for-existing-storage-group)
    -   [Remove volumes from storage
        group](#remove-volumes-from-storage-group)
    -   [Remove volumes from SRDF protected storage
        group](#remove-volumes-from-srdf-protected-storage-group)
    -   [Add child storage group to parent storage
        group](#add-child-storage-group-to-parent-storage-group)
    -   [Remove child storage group from parent storage
        group](#remove-child-storage-group-from-parent-storage-group)
    -   [Rename storage group](#rename-storage-group)
    -   [Storage Group module
        parameters](#storage-group-module-parameters)
        -   [Table 3. Parameters
            (continued)](#table-3.-parameters-continued)
-   [Volume module](#volume-module)
    -   [Create volume](#create-volume)
    -   [Expand volume](#expand-volume)
    -   [Rename volume](#rename-volume)
    -   [Delete volume](#delete-volume)
    -   [Move volumes between storage
        group](#move-volumes-between-storage-group)
    -   [Add new volume to SRDF protected storage
        group](#add-new-volume-to-srdf-protected-storage-group)
    ...
    -   [Expand volume of SRDF protected storage group using volume
        identifier](#expand-volume-of-srdf-protected-storage-group-using-volume-identifier)
    -   [Get volume using WWN](#get-volume-using-wwn)
    -   [Expand volume using WWN](#expand-volume-using-wwn)
    -   [Move volumes between storage groups using
        WWN](#move-volumes-between-storage-groups-using-wwn)
    -   [Rename volume using WWN](#rename-volume-using-wwn)
    -   [Delete volume using WWN](#delete-volume-using-wwn)
    -   [Volume module parameters](#volume-module-parameters)
        -   [Table 4. Parameters ](#table-4.-parameters)
        -   [Table 4. Parameters
            (continued)](#table-4.-parameters-continued)
-   [Host module](#host-module)
    -   [Create host](#create-host)
    -   [Get details of the host](#get-details-of-the-host)
    -   [Add initiator to host](#add-initiator-to-host)
    -   [Remove initiators from host](#remove-initiators-from-host)
    -   [Modify host flags](#modify-host-flags)
    -   [Rename host](#rename-host)
    -   [Delete host](#delete-host)
    -   [Host module parameters](#host-module-parameters)
        -   [Table 5. Parameters ](#table-5.-parameters)
        -   [Table 5. Parameters
            (continued)](#table-5.-parameters-continued)
-   [Host group module](#host-group-module)
    -   [Create host group](#create-host-group)
    -   [Get details of host group](#get-details-of-host-group)
    -   [Add host to host group](#add-host-to-host-group)
    -   [Remove host from host group](#remove-host-from-host-group)
    -   [Modify host group flags](#modify-host-group-flags)
    -   [Rename host group](#rename-host-group)
    -   [Delete host group](#delete-host-group)
    -   [Host Group module parameters](#host-group-module-parameters)
        -   [Table 6. Parameters ](#table-6.-parameters)
        -   [Table 6. Parameters
            (continued)](#table-6.-parameters-continued)
        -   [Table 6. Parameters
            (continued)](#table-6.-parameters-continued-1)
-   [Port module](#port-module)
    -   [Get details of single/multiple
        ports](#get-details-of-singlemultiple-ports)
    -   [Port module parameters](#port-module-parameters)
        -   [Table 7. Parameters ](#table-7.-parameters)
        -   [Table 7. Parameters
            (continued)](#table-7.-parameters-continued)
-   [Port Group module](#port-group-module)
    -   [Create port group without
        ports](#create-port-group-without-ports)
    -   [Create port group with ports](#create-port-group-with-ports)
    -   [Add ports to port group](#add-ports-to-port-group)
    -   [Remove ports from port group](#remove-ports-from-port-group)
    -   [Rename port group](#rename-port-group)
    -   [Delete port group](#delete-port-group)
    -   [Port Group module parameters](#port-group-module-parameters)
        -   [Table 8. Parameters ](#table-8.-parameters)
        -   [Table 8. Parameters
            (continued)](#table-8.-parameters-continued)
-   [Masking View module](#masking-view-module)
    -   [Create masking view with host
        group](#create-masking-view-with-host-group)
    -   [Create masking view with host](#create-masking-view-with-host)
    -   [Rename masking view](#rename-masking-view)
    -   [Delete masking view](#delete-masking-view)
    -   [Masking View module
        parameters](#masking-view-module-parameters)
        -   [Table 9. Parameters ](#table-9.-parameters)
        -   [Table 9. Parameters
            (continued)](#table-9.-parameters-continued)
-   [Snapshot module](#snapshot-module)
    -   [Create snapshot for a storage
        group](#create-snapshot-for-a-storage-group)
    -   [Get details of storage group
        snapshot](#get-details-of-storage-group-snapshot)
    -   [Delete storage group snapshot](#delete-storage-group-snapshot)
    -   [Rename storage group snapshot](#rename-storage-group-snapshot)
    -   [Change snapshot link status to
        linked](#change-snapshot-link-status-to-linked)
    -   [Change snapshot link status to
        unlinked](#change-snapshot-link-status-to-unlinked)
    -   [Snapshot module parameters](#snapshot-module-parameters)
        -   [Table 10. Parameters ](#table-10.-parameters)
        -   [Table 10. Parameters
            (continued)](#table-10.-parameters-continued)
-   [SRDF Module](#srdf-module)
    -   [Create SRDF links](#create-srdf-links)
    -   [Create and establish a storage group SRDF/a
        pairing](#create-and-establish-a-storage-group-srdfa-pairing)
    -   [Create a storage group SRDF/s pair in suspended
        mode](#create-a-storage-group-srdfs-pair-in-suspended-mode)
    -   [Get SRDF details](#get-srdf-details)
    -   [Modify SRDF mode](#modify-srdf-mode)
    -   [Failover SRDF link](#failover-srdf-link)
    -   [Failback SRDF link](#failback-srdf-link)
    -   [Create storage group Metro SRDF pair with Witness for
        resiliency](#create-storage-group-metro-srdf-pair-with-witness-for-resiliency)
    -   [Get SRDF Job status](#get-srdf-job-status)
    -   [Establish SRDF link](#establish-srdf-link)
    -   [Create and Establish concurrent SRDF
        link](#create-and-establish-concurrent-srdf-link)
    -   [Suspend SRDF link](#suspend-srdf-link)
    -   [Suspend concurrent SRDF link](#suspend-concurrent-srdf-link)
    -   [Delete SRDF link](#delete-srdf-link)
    -   [Delete concurrent SRDF link](#delete-concurrent-srdf-link)
    -   [SRDF module parameters](#srdf-module-parameters)
        -   [Table 11. Parameters
            (continued)](#table-11.-parameters-continued)
-   [RDF Group module](#rdf-group-module)
    -   [Get RDF group and volumes
        details](#get-rdf-group-and-volumes-details)
    -   [RDF Group module parameters](#rdf-group-module-parameters)
        -   [Table 12. Parameters ](#table-12.-parameters)
        -   [Table 12. Parameters
            (continued)](#table-12.-parameters-continued)
